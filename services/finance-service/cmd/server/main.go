...
import (
	...
	"finance-service/internal/config"
	"finance-service/internal/database"
	"finance-service/internal/handler"
	"finance-service/internal/middleware"
	"finance-service/internal/router"
	"finance-service/internal/seed"
)
